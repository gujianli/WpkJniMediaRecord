		...
		int l1, int l2)
{
	...
	swataw->_mb[0] = new swataw_mb_t[n];
	swataw->_mb[1] = new swataw_mb_t[n];
	memset(swataw->_mb[0], 0, sizeof(swataw_mb_t)*n);
	memset(swataw->_mb[1], 0, sizeof(swataw_mb_t)*n);
	swataw->_data[0] = new swataw_data_t[n];
	swataw->_data[1] = new swataw_data_t[n];
...
swataw_close(void* st)
{
	...
	delete[] swataw->_mb[0];
	delete[] swataw->_mb[1];
	delete[] swataw->_data[0];
	delete[] swataw->_data[1];
}
